 ...
 * ------ --------- -------------------------------------------------
 * 03/2013 G. Lucas Created as part of IncrementalTIN using a walking
 *                    algorithm suggestd by Scott Martin
 * 04/2014 G. Lucas Added extended-precision calculations to search
...
public class StochasticLawsonsWalk {
   ...
   */
  public StochasticLawsonsWalk(final double nominalPointSpacing) {
   ...
   *
   * @param startingEdge the edge giving both the starting point of the search
   ...
   */
  private QuadEdge findAssociatedPerimeterEdge(
          final QuadEdge startingEdge,
          final double x,
          final double y) {
